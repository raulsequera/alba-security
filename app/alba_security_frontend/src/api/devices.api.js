...
const devicesApi = axios.create({
  baseURL: `${URL}/alba/api/v1`,
});

export const getLanding = () => devicesApi.get("/");
...
export const getDevices = () => devicesApi.get("/get-devices/");

export const getScanStarted = () => devicesApi.get("/scan-devices/");

export const getDeviceNameFromIP = (ip) =>  devicesApi.get(`/device-name/${ip}/`);
