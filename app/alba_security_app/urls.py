...
from alba_security_app import views
...
urlpatterns = [
    ...
    path('api/v1/get-devices/', views.GetDevices.as_view(), name="get-devices"),
    path('api/v1/scan-devices/', views.ScanDevicesStart.as_view(), name='scan-devices'),
    path('api/v1/device-name/<str:ip>/', views.GetDeviceName.as_view(), name="device-name"),
